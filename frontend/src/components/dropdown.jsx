  ...
  return (
    <div ref={dropdownRef} className="relative">
      <button 
        ...
        type="button"
        className="hover:bg-slate-600 rounded-lg p-1 transition-colors"
      >
        <svg 
      ...
      {openDropdown && (
        <div 
          className="absolute top-full right-0 mt-2 w-52 bg-[#0f1623] border border-cyan-500/30 rounded-lg shadow-[0_0_30px_rgba(34,211,238,0.2)] overflow-hidden z-50"
        >
          <ul className="py-2">
            <li>
              <a 
